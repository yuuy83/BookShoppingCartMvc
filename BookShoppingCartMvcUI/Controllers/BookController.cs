...
using BookShoppingCartMvcUI.Models.DOTs;
...
public class BookController : Controller
{
    ...
    public async Task<IActionResult> AddBook()
    {
        ...
        BookDOT bookToAdd = new() { GenreList = genreSelectList };
        return View(bookToAdd);
    }

    [HttpPost]
    public async Task<IActionResult> AddBook(BookDOT bookToAdd)
    {
        var genreSelectList = (await _genreRepo.GetGenres()).Select(genre => new SelectListItem
        {
            Text = genre.GenreName,
    ...
    [HttpPost]
    public async Task<IActionResult> UpdateBook(BookDOT bookToUpdate)
    {
        var genreSelectList = (await _genreRepo.GetGenres()).Select(genre => new SelectListItem
        {
            Text = genre.GenreName,
